"""spring-system file for ensuring the package is executable
as `spring-system` and `python -m spring_system`
"""
...
def main(*args, **kwargs):
    ...
    context = KedroContext(package_name)
    catalog = _get_catalog(context)

    logger.info("Catalog in main: %s", catalog)
